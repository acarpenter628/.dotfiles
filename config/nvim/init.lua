...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      require('boole').setup({
        ...
        -- User defined loops
        -- additions = {
        --   -- ABC TODO this seemed to only somewhat work?  Seems like it should be enabled by default
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grh', "<cmd>LspClangdSwitchSourceHeader<cr>", '[G]oto [H]eader / Source')
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'main',  -- ABC TODO NOW I guess I have to update to main now maybe.  https://www.qu8n.com/posts/treesitter-migration-guide-for-nvim-0-12
    build = ':TSUpdate',
